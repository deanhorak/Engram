...
Training records/steps: 8/6; validation records: 4.

| Metric | Mean | Threshold | Pass |
|---|---:|---:|---|
| Candidate recall | 0.900185 | ≥0.95 | no |
| Teacher-student KL | 0.142503 | ≤0.05 | no |
| Teacher top-1 agreement | 0.757576 | ≥0.90 | no |
| NLL delta | 0.154349 | ≤0.05 | no |
| Final hidden relative L2 | 0.169266 | ≤0.10 | no |
| Candidate cache-line fraction | 0.998681 | minimize | informational |
| Scalar projected traffic | 0.611111× dense | informational | — |
| Cache-adjusted traffic | 0.777448× dense | <1.0× | yes |
