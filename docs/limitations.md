...
- No trained checkpoint was present, and the project never silently downloads one.
...
- The installed optional conversion stack currently has Transformers 5.5.4 and an older
  scikit-learn incompatible with NumPy 2.4.6; two local-Hugging-Face integration tests skip
